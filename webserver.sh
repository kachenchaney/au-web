...
# Clone the shn-main repository to /var/www/
cd /var/www/ && git clone https://github.com/kachenchaney/shn-main.git

# Give permission to access asset directory and index.php file
chmod 777 -R /var/www/shn-main/
...
cp /var/www/shn-main/asset/shell/000-default.conf .
...
sed -i 's/localhost/database/g' /var/www/shn-main/asset/koneksi.php
sed -i 's/root/admin/g' /var/www/shn-main/asset/koneksi.php
sed -i 's/\"\"/\"admin123\"/g' /var/www/shn-main/asset/koneksi.php
...
source /var/www/shn-main/asset/database/datasiswa.sql
